...
import org.apache.flink.streaming.tests.sources.AuctionStatelessSourceFunction;
import org.apache.flink.streaming.tests.sources.PersonSourceFunction;
import org.apache.flink.streaming.tests.sources.PersonStatelessSourceFunction;
...
public class Query8WithoutChaining {

    private static final Logger logger  = LoggerFactory.getLogger(Query8WithoutChaining.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Person> persons = env.addSource(
                stateless
                        ...
                        : new PersonSourceFunction(personSrcRate))
        ...
        DataStream<Auction> auctions = env.addSource(
                stateless
                        ...
                        : new AuctionSourceFunction(auctionSrcRate))
